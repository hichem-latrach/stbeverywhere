...
import { Users, CreditCard, FileText, Settings, HelpCircle, LogOut, TrendingUp, AlertTriangle, BarChart3, UserCheck } from 'lucide-react';
...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ activeTab, setActiveTab }) => {
  const { user, logout, getAdminData } = useAuth();
...
{ id: 'student-files', name: 'TF Bank', icon: Users },
  ...
  return (
    <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="flex items-center space-x-2 px-6 pt-4 pb-6">
        <img 
