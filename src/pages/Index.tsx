...
const Index: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 lg:px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <Link to="/login">
                <Button variant="outline" className="border-gray-300 text-gray-700 hover:bg-gray-50 px-8 py-4 text-lg font-medium">
                  Access My Account
                </Button>
              </Link>
              <Link to="/signup">
                <Button className="bg-stb-purple hover:bg-stb-purple/90 text-white px-8 py-4 text-lg font-medium">
                  Join STB Everywhere
                </Button>
              </Link>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
                ...
                {features.map((feature, index) => (
                  <Card key={index} className="text-center border-2">
                    <CardContent className="p-6">
                      <div className="text-3xl font-bold text-stb-teal mb-2">{feature.title}</div>
                      <div className="text-gray-600">{feature.subtitle}</div>
                    </CardContent>
                  </Card>
                ))}
              </div>
              ...
              <div className="space-y-4">
                ...
                />
                <Link to="/signup">
                  <Button className="w-full bg-stb-purple hover:bg-stb-purple/90 text-white py-3 font-semibold">
                    Get Started
                  </Button>
                </Link>
              </div>
                ...
                <CardContent className="p-8">
                  ...
                  <Link to="/signup">
                    <Button 
                      ...
                      className={service.variant === 'default' ? 'bg-stb-purple hover:bg-stb-purple/90 text-white px-8 py-3 font-semibold' : 'border-stb-teal text-stb-teal hover:bg-stb-teal hover:text-white px-8 py-3 font-semibold'}
                    >
                      {service.buttonText}
                    </Button>
                  </Link>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {latestNews.map((news, index) => (
              <Card key={index} className="hover:shadow-xl transition-shadow border-2">
                ...
                <CardContent className="p-6">
                  <div className="text-sm text-stb-teal font-medium mb-2">{news.date}</div>
                  <h3 className="text-xl font-bold text-black mb-3">{news.title}</h3>
                  <p className="text-gray-700 mb-4">{news.description}</p>
                  <Link to={`/blog/${news.id}`}>
                    <Button variant="outline" className="text-stb-teal border-stb-teal hover:bg-stb-teal hover:text-white font-semibold">
                      Read More
                    </Button>
                  </Link>
                </CardContent>
      ...
      <section className="bg-stb-purple py-16">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
              <input
                ...
                required
              />
              <Button type="submit" className="bg-white text-stb-purple hover:bg-gray-100 px-6 py-3 font-semibold">
                Subscribe
              </Button>
            </form>
          </div>
